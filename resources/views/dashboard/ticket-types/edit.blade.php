    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.ticket-types.update', $ticketType->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="row p-5">
                        <h3>{{ __('Edit Ticket Type') }}</h3>
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text"
                                ...
                                autofocus value="{{ old('name', $ticketType->name) }}" />
                            @error('name')
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('slug') is-invalid @enderror" type="text"
                                ...
                                autofocus value="{{ old('slug', $ticketType->slug) }}" />
                            @error('slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('description') is-invalid @enderror" type="text"
                                id="description" name="description" placeholder="{{ __('Enter description') }}"
                                autofocus value="{{ old('description', $ticketType->description) }}" />
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Update Ticket Type') }}</button>
                    </div>
                </form>
